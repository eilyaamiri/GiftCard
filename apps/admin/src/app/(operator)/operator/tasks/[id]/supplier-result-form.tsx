  ...
  const body = (
    <>
      ...
      {assetType === "PROVIDER_DIRECT_EMAIL" ? (
        <p className="muted">
          {variant === "INTERNATIONAL_PAYMENT"
            ? "در این حالت سرویس تأییدیهٔ اصلی را مستقیماً ایمیل می‌کند؛ اسکرین‌شاتی که در بخش بالا ثبت کرده‌اید نیز همراه اعلام نتیجهٔ برات‌پی برای مشتری فرستاده می‌شود."
