...
export interface AssetDeliveryAttachment {
  /** Generated by the server; an operator-supplied filename never crosses this port. */
...
export interface AssetDeliveryMessage {
  ...
  readonly expiryDate?: Date | null;
  /** Customer-visible payment evidence, attached only on international-payment delivery. */
  readonly attachments?: readonly AssetDeliveryAttachment[];
}
